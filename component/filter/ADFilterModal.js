  ...
  <div id="ad-filter" class="modal">
    <div class="modal-content">
      ...
      <div class="filter-blocker sub-checkbox-block-1">
        ...
        <div>
          <input type="checkbox" class="checkbox checkbox-block-1" id="resource14" name="網頁遊戲APP下載" value="網頁遊戲APP下載">
        ...
        <div>
          <input type="checkbox" class="checkbox checkbox-block-1" id="resource20" name="懶人包課堂學習" value="懶人包課堂學習">
        ...
        <div>
          <input type="checkbox" class="checkbox checkbox-block-1" id="resource23" name="戶外體驗角色扮演" value="戶外體驗角色扮演">
        ...
        <div>
          <input type="checkbox" class="checkbox checkbox-block-1" id="resource31" name="微電影全選" value="微電影全選">
      ...
      <div class="filter-blocker sub-checkbox-block-2">
        ...
        <div>
          <input type="checkbox" class="checkbox checkbox-block-2" id="resource38" name="災害防救。能源資源永續利用" value="災害防救。能源資源永續利用">
      ...
      <div class="filter-blocker">
        ...
        <div>
          <input type="checkbox" class="checkbox checkbox-block-3" id="resource49" name="氣候變遷" value="氣候變遷">
          <label for="resource49"> 氣候變遷 </label><br>
        </div>
        <div>
          <input type="checkbox" class="checkbox checkbox-block-3" id="resource50" name="永續發展" value="永續發展">
          <label for="resource50"> 永續發展 </label><br>
        </div>
        <div>
          <input type="checkbox" class="checkbox checkbox-block-3" id="resource51" name="教育推廣" value="教育推廣">
          <label for="resource51"> 教育推廣 </label><br>
        </div>
        <div>
          <input type="checkbox" class="checkbox checkbox-block-3" id="resource53" name="其他" value="其他">
