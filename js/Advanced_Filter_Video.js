$(document).ready(async function () {
  ...
  document.title = `水保酷學堂 - ${GA_SUBJECT}`;
...
async function downloadVideo() {
  const resourceFCName = document.querySelector(
    "#resource-fc-name > h5"
  ).innerText;
...
async function addNews() {
  ...
  const data = {
    action: "create",
    subject: `您好,您已申請下載 360 影片,詳情請查看 360 影片下載專區`,
    SOURCE_NO: `${url}/pages/user.html?page=360-video-download-area`,
    CATEGORY_NO: 16,
    CATEGORY: "360影片",
