<?php
require_once __DIR__ . '/prize-apply-digital.php';

class PrizeApplyDigitalCompletedEmailSender extends PrizeApplyDigitalEmailSender{
    protected $table_title = '<p>親愛的 {{name}} 您好：<br>
    恭喜您成功兌換【{{prize_title}}】。此禮品為電子票券，請於結帳前出示票券。
    </p>';
